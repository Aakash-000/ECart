...
export default function ProductDetailPage({ params }: { params: { id: string } }) {
  ...
  const product = {
    ...
    reviews: 171,
    description:
        "Experience the magic of high-fidelity audio with AirPods Max. The perfect balance of exhilarating high-fidelity audio and the effortless magic of AirPods. The ultimate personal listening experience is here.",
    features: [
      "High-fidelity audio",
