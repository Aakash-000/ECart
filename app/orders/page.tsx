          ...
          {orders.map((order) => (
            ...
            >
              ...
              <div className="mt-4">
                ...
                <p className="text-gray-700 text-sm">{order.shipping_address_line1}</p>
                <p className="text-gray-700 text-sm">{order.shipping_address_city} {order.shipping_address_state} {order.shipping_address_postal_code}</p>
              </div>
